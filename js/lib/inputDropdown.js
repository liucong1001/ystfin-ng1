...
angular.module('inputDropdown', []).directive('inputDropdown', [function() {
    var templateString =
        ...
        '>' +
        '<span compile="itemTemplate"></span>' +
            /*
        '<span ng-if="item[textField]">{{item[textField]}}</span>' +
        '<span ng-if="!item[textField]">{{item}}</span>' +
        */
        '</li>' +
        '</ul>' +
        '</div>';
                ...
                if (!angular.equals(newValue, oldValue)) {
                    if (newValue) {
                        ...
                        if (typeof newValue === 'string') {
                            ...
                            scope.inputValue = newValue[scope.textField];
                        }
                    }
                    else {
